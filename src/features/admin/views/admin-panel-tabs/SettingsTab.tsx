                ...
                <div className="bg-card p-6 rounded-xl border border-gray-800 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="power-org-scrims" className="text-xs text-gray-500 uppercase font-bold mb-1 block">Power Org Scrims Requirement</label>
                                <div className="relative">
                                    <input 
                                        id="power-org-scrims"
                                        type="number" 
                                        min="1"
                                        max="100"
                                        value={minAuthenticScrimsForPowerOrg ?? 20}
                                        onChange={e => setMinAuthenticScrimsForPowerOrg?.(e.target.value)}
                                        className="w-full bg-dark border border-gray-700 rounded-lg p-3 pr-16 text-white focus:border-brand-500 focus-visible:outline-none font-bold"
                                        placeholder="20"
                                    />
                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-bold">Scrims</span>
                                </div>
                                <p className="text-[10px] text-gray-400 mt-1">
                                    Number of authentic completed scrims required for standard organizers to unlock Power status application (Default: 20).
                                </p>
                            </div>
                        </div>
