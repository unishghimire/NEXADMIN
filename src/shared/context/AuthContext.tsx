...
// Authoritative admin verification: claims-first, doc-fallback (BUG-030).
// Client cannot assign itself admin. Role is verified server-side on all admin operations.
